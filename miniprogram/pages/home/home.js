...
Page({
  ...
  closeGuide(e){//监听触摸结束关闭指南
   // console.log(e.changedTouches[0].pageX)
    var change=this.data.changeTouch-e.changedTouches[0].pageX
   // console.log(change)
    var catchtouch= e.currentTarget.dataset.title
  if(catchtouch==2 && change>10){
    this.setData({
      instruction:false,       
      guide:'guide',//打开分类指导
      btnShow:false//打开指导箭头
    })
  }
  },
  closeGuide1(e){//监听触摸开始
   // console.log(e.changedTouches[0].pageX)
    this.setData({
      changeTouch:e.changedTouches[0].pageX
    })
  },
  ...
  data: {
    ...
    activity:[{
      title:"pic1",
        imagePath:"cloud://rayhomie.7261-rayhomie-1301936252/4.jpg"
    },
  {
    title:"pic2",
        imagePath:"cloud://rayhomie.7261-rayhomie-1301936252/5.jpg"
  },
{
  title:"pic3",
        imagePath:"cloud://rayhomie.7261-rayhomie-1301936252/6.jpg"
}]
